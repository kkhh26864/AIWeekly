...
Usage:
    ./ai-weekly.py                             # Generate default 500-char report
    ./ai-weekly.py --chars 500                 # Custom word count
    ./ai-weekly.py --filter plugin             # Filter repositories
    ./ai-weekly.py --exclude test              # Exclude repositories
    ./ai-weekly.py --raw                       # Show raw commits only
    ./ai-weekly.py --api-key "sk-xxx"          # Override API key
    ./ai-weekly.py 简洁的 技术 总结              # Custom writing style
    ./ai-weekly.py --since "2024-01-15"        # From specific date
...
Examples:
    ...
    ./ai-weekly.py --chars 150 --filter "core|main"

    # Use OpenAI
    export OPENAI_API_KEY="sk-openai-key"
    export OPENAI_BASE_URL="https://api.openai.com/v1"
    export OPENAI_MODEL="gpt-4"
    ./ai-weekly.py --chars 800
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog='Examples:\n'
               '  ./ai-weekly.py --chars 150 --filter "core|main"\n'
               '  ./ai-weekly.py --chars 800 --exclude "test|temp"\n'
               '  ./ai-weekly.py --raw --filter plugin\n'
               '  ./ai-weekly.py 简洁的 技术 总结 --chars 200\n'
               '  ./ai-weekly.py --since "2024-01-15" --chars 500\n'
               '  ./ai-weekly.py --days 30 技术 月报\n\n'
               'Environment Setup:\n'
